...
openssl req -x509 -nodes -days 365 -newkey rsa:2048 -keyout /etc/nginx/ssl/private/localhost.key -out /etc/nginx/ssl/certs/localhost.crt -subj "/C=FR/ST=Paris/L=Paris/O=ECOLE 42PARIS/OU=ECOLE 42PARIS/CN=localhost"
